...
connection = sqlite3.connect('vehicledatabase.db')  # connects the given database to init_db.py ,creates if not created
with open('vehicledetails.sql') as f:  # creates a table in database
...
plate_numbers = ['PZ65BYV','YD63LB','MH01AV8866','25GFJX','MH15BD8877','M771276','73LTG4','JA62UAR','06ZRZZ','B2228HM',
                 'BAD231','P3RVP','KA1SER','695299','15LK10898','9TBZ74','RP524X','ZH175G','V971KZ','11SZSR',
                'GSDS79','82TGLP','HL821D','172TMJ','4940TD53','8XRJ16','HR26DA0471','PGMN112','TN07BU5427',
                 '7ZBG58','GJW115A1138','21XHLR','700V','MH12JC2813','6PIV728','ZG169D','MY02ZRO','85SLX2',
                 'DAN54P','V554JT','PJC4903','PJH0957','MH20DV2362','FZJ55T','HR26DK0830','PJI5396','PJU2207',
                 'PJU2853','MP09CP9052','1T43213','HR26BP3543','RK906AJ','RK892AE','KL55R2473','1B80338','BZM2227',
                 '4BO4979','1B19839','4B40262','2T40211','4B39376','3B29485','RK959AF','RK641AL','RK959AD','LM169AM',
                 '4PCI264','9185914','EAZ6913','HH9G5W','NZP8292','M5XSX','627WWI','PJG0783','HB8X9J','HR26DA2330',
                 'RK828AG','MH02CT2727','RK248AH','RK161AG','TN87TC111','DL8CAF5030','DL3CAM0857','64XJRK','84ZRZB',
                 'KL01KLKL01','TN07BV5200','KA031351','MH46Z8892','MH20CS9817','MH20EE7601','MH20EE7598','HR696969',
                 'HR26DK6475','KA29Z999','KL10AV6633','256D259','DL8CX4850','HR26BR9044','ASM28965']
for i in range(100):
